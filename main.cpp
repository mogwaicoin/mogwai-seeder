...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    ...
    static const char *help = "MogwaiCoin-seeder\n"
...
static const string mainnet_seeds[] = {"static-dns1.mogwaicoin.org", "static-dns2.mogwaicoin.org", "static-dns3.mogwaicoin.org", "static-dns4.mogwaicoin.org", "static-dns5.mogwaicoin.org", "static-dns6.mogwaicoin.org", ""};
static const string testnet_seeds[] = {"static-dns-test1.mogwaicoin.info", "static-dns-test2.mogwaicoin.info", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("mogwaicoin.net", 17777), true);
  }
  do {
